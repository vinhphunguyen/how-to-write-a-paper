...
\begin{keyword}
 scientific writing; \LaTeX; scientific publication; high quality writing; reproducibility.
\end{keyword}
...
\cref{sec:equation} and figures in \cref{sec:citing-figs}.
...
\item not contain abbreviations;
\item not include phrases such as "study of," "analysis of" or similar constructions.
\end{itemize}
...
\end{itemize}
We do not need to be a native English to recognize that the above list is wrong. Just by reading it out loud we can see that the first three bullet points are ok, but something wrong with the fourth and fifth bullets.
...
\item A study of the phenomena of crack kinking and sawtooth cracking in strongly anisotropic brittle fracture.
\end{itemize}
...
We do not want to discuss about punctuations in equations as this problem is still a debate. Do whatever you feel comfortable with. But the editor can ask you to add punctuations in your equations!
