...
% arara: bibtex
% arara: pdflatex: {synctex: on} if
% arara: --> (changed('bbl')) 
% arara: pdflatex if changed('gls') || changed('ind')
...
To improve the scientific writing, books and articles giving advice on how to write clear papers have been written \citep{strunk2007elements,day1998write,ashby2000write,plaxco2010art}. Building on the advice found in these works and our total 20 years of experiences, this brief paper gives guidance in writing high quality research papers. By high quality papers, we mean those of which scientific findings are not buried under a poorly written text. The paper is centered around three parts. 
