...
\begin{figure*}[!h]
  ...
  the overall structure of the paper. },label={snippet_template},framerule=1pt,tabsize=3]
    \documentclass[authoryear,3p,times,preprint,review,fleqn]{elsarticle}
    \title{\textbf{}}
    \begin{abstract}
    \end{abstract}
...
In what follows, \cref{sec:packages} we discuss how to prepare high quality plots in \cref{sec:figs}, tables in 
